"""
Model 6: Fine-tuned DeBERTa-v3 Small Pairwise Classifier
Smart MCQ Solver Challenge

This script is a standalone version of the Model 6 training and submission notebooks.
"""
...
print("DeBERTa model and metrics saved successfully.")
...
print("Saved DeBERTa model loaded successfully.")
